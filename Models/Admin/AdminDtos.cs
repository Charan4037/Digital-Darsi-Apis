...
public class CustomerDto
{
    ...
    /// <summary>App version (e.g. "1.1.2") and platform ("android"/"ios")
    /// from the customer's most recently active device — null when they've
    /// never registered a device token.</summary>
