...
[ApiController]
[Route("api/shop/customer-address-tokens")]
[Tags("CustomerAddressToken")]
[Authorize]
public class ShopCustomerAddressTokenController : ControllerBase
{
    private readonly AccountService _accountService;

    public ShopCustomerAddressTokenController(AccountService accountService)
    {
        _accountService = accountService;
    }

    /// <summary>List addresses with tokens</summary>
    [HttpGet]
