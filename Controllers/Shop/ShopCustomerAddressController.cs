...
[ApiController]
[Route("api/shop/customer-addresses")]
[Tags("CustomerAddress")]
[Authorize]
public class ShopCustomerAddressController : ControllerBase
{
    private readonly AccountService _accountService;

    public ShopCustomerAddressController(AccountService accountService)
    {
